...
export GITHUB_USER="(echo U2FsdGVkX1/fnYPPV4iIQMD22P2UcKj4bUXPbTlZSok= | openssl enc -d -aes-256-cbc -md sha512 -a -salt -pass pass:$PASSWORD)"                                                        # Parameter nach -a "-pbkdf2 -iter 100000" funktionieren nur manchmal daher entfernt
export GITHUB_CLIENT_ID="(echo U2FsdGVkX1+0HGvBXtVWAZCk0/A4OrfGrc3rEMUbVAbJWfMwAnyjTq9Pea0WyBOl | openssl enc -d -aes-256-cbc -md sha512 -a -salt -pass pass:$PASSWORD)"                               # Parameter nach -a "-pbkdf2 -iter 100000" funktionieren nur manchmal daher entfernt
export GITHUB_CLIENT_SECRET="(echo U2FsdGVkX1+2WJJ16oRQLWO6exdrBOyVrpKly7hhbRJdSb2xUcEplPU5+vLYUXn2fRw4Nhm9OPICBYoIChabsA== | openssl enc -d -aes-256-cbc -md sha512 -a -salt -pass pass:$PASSWORD)"   # Parameter nach -a "-pbkdf2 -iter 100000" funktionieren nur manchmal daher entfernt
